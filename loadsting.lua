    ...
    Callback = function(val)
        pcall(function()
            ...
            if hum and val then
                ...
                Rayfield:Notify({Title = "Air Swim ON", Content = "Swimming in the air!", Duration = 2})
            end
        end)
    end
})
...
MovementTab:CreateToggle({
    ...
    Callback = function(val)
        if val then
            ...
            Rayfield:Notify({Title = "Bunny Hop ON", Content = "Hop like a rabbit!", Duration = 2})
        end
    end
})
    ...
    Callback = function()
        pcall(function()
            ...
            if root then
                ...
                Rayfield:Notify({Title = "Dash!", Content = "Speed boost forward!", Duration = 1})
            end
        end)
    end
})
...
MovementTab:CreateToggle({
    ...
    Callback = function(val)
        if val then
            spawn(function()
                while val do
                    pcall(function()
                        local hum = getHumanoid()
                        if hum and UserInputService:IsKeyDown(Enum.KeyCode.Space) then
                            local ray = Ray.new(getRoot().Position, getRoot().CFrame.LookVector * 3)
            ...
            Rayfield:Notify({Title = "Wall Climb ON", Content = "Climb any wall!", Duration = 2})
        end
    end
})
    ...
    Callback = function()
        pcall(function()
            ...
            if root then
                spawn(function()
                    for i = 1, 10 do
                        root.CFrame = root.CFrame * CFrame.Angles(0, math.rad(36), 0) + root.CFrame.LookVector * 5
                        wait(0.05)
                    end
                end)
                Rayfield:Notify({Title = "Spin Dash!", Content = "Sonic style!", Duration = 2})
            end
        end)
    end
})
...
MovementTab:CreateToggle({
    ...
    CurrentValue = false,
    Callback = function(val)
        workspace.Gravity = val and 50 or 196
        Rayfield:Notify({Title = val and "Low Gravity ON" or "Normal Gravity", Content = val and "Float like a feather!" or "Back to normal", Duration = 2})
    end
})
    ...
    Callback = function()
        pcall(function()
            ...
            if root then
                ...
                explosion.Parent = workspace
                Rayfield:Notify({Title = "Rocket Jump!", Content = "To the moon!", Duration = 2})
            end
        end)
    end
})
...
WeatherTab:CreateSection("Weather Control")
...
WeatherTab:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({Title = "Weather", Content = "Sunny day!", Duration = 2})
    end
})
...
WeatherTab:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({Title = "Weather", Content = "Night time!", Duration = 2})
    end
})
...
WeatherTab:CreateButton({
    ...
    Callback = function()
        ...
        Lighting.OutdoorAmbient = Color3.fromRGB(255, 100, 50)
        Rayfield:Notify({Title = "Weather", Content = "Beautiful sunset!", Duration = 2})
    end
})
    ...
    Callback = function(val)
        pcall(function()
            if val then
                ...
                rain.Size = NumberSequence.new(0.1, 0.1)
                rain.Parent = workspace.Terrain
                Rayfield:Notify({Title = "Rain ON", Content = "It's raining!", Duration = 2})
            else
...
WeatherTab:CreateButton({
    ...
    Callback = function()
        ...
        Rayfield:Notify({Title = "Storm!", Content = "Thunder and lightning!", Duration = 2})
    end
})
...
-- TAB 26: SOUNDS
-- ============================================
local SoundsTab = Window:CreateTab("🔊 Sounds", nil)
SoundsTab:CreateSection("Sound Controls")

local sounds = {
    ["Victory"] = "rbxassetid://1843423846",
    ["Fail"] = "rbxassetid://1843423846",
    ["Explosion"] = "rbxassetid://165969964",
    ["Laser"] = "rbxassetid://130113322",
    ["Bell"] = "rbxassetid://138081500",
    ["Woosh"] = "rbxassetid://151790502"
}
    ...
    SoundsTab:CreateButton({
        ...
        Callback = function()
            pcall(function()
                ...
                Rayfield:Notify({Title = "Sound", Content = name.." played!", Duration = 2})
            end)
        end
    })
end

SoundsTab:CreateInput({
...
SoundsTab:CreateButton({
    Name = "▶️ Play Custom Sound",
    Callback = function()
        pcall(function()
            if _G.CustomSoundID then
                local sound = Instance.new("Sound")
                sound.SoundId = "rbxassetid://".._G.CustomSoundID
                sound.Volume = 0.5
                sound.Parent = workspace
                sound:Play()
                game:GetService("Debris"):AddItem(sound, 10)
                Rayfield:Notify({Title = "Custom Sound", Content = "Playing...", Duration = 2})
            end
        end)
    end
})

SoundsTab:CreateSlider({
    Name = "🔊 Master Volume",
    Range = {0, 10},
    Increment = 1,
    CurrentValue = 5,
